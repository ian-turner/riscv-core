...
slli x1, x1, 8			# this is done by placing each 8 bits and 
				# shifting since the real value is too large for U-type imm
addi x2, zero, 153		
...
addi x5, zero, 10		# setting x5 to 10 to use later for mul
				
#addi x2, zero, 1829		# arbitrary input value
				# (hard-coded)
...
# digit 2			# repeat process for each 8 digits
slli x6, x6, 4
mul x3, x2, x1
mulhu x2, x2, x1
mulhu x7, x3, x5
